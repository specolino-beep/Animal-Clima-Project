            ...
            >
              <section className="bg-slate-800 rounded-2xl p-8 shadow-lg relative overflow-hidden border-none">
                ...
                <div className="relative z-10 max-w-2xl">
                  <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight font-montserrat"><span className="text-4xl block mb-2">Animal Clima Project</span>Progettare Benessere Animale</h2>
