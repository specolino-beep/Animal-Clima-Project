...
export function SistemiRaffrescamentoConvettivi({ 
  params, 
  setParams, 
  setCurrentView, 
  buildingDimensions,
    ...
    >
      <section className="bg-slate-800 rounded-2xl border border-slate-700 p-8 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-extrabold text-white mb-2 font-montserrat">Sistemi di Raffrescamento Convettivi</h2>
